let textosLeitura = [
    ...
    },
    {
        id: 'felicidade',
        titulo: 'Felicidade',
        texto: 'Cada espírito é um canal de bênçãos, em se mantendo ligado às Leis do criador. Lembre - se: você pode espalhar compreensão e otimismo. Contemple a fonte ao dissipar as formações de lama que se lhe atira à corrente. Não se detenha em pessimismo e azedume. Qualquer tristeza manifestada impulsiona os tristes a ficarem mais tristes. Fraqueza à mostra enfraquece os fracos ainda mais. Encoraje o próximo com o seu sorriso, entregando suas mágoas a Deus. Não se sabe de benefício algum que o desânimo tenha realizado. Siga em frente, criando simpatia e amizade, esperança e cooperação. Felicidade é um fruto que se colhe da felicidade que se semeia. Plante amor e paz e a vida lhe trará farta colheita de paz e amor. Quando a provação lhe apareça, terá surgido o seu momento mais importante para comunicar fé e coragem aos companheiros. Quando o sofrimento desponte na estrada de alguém, estará você obtendo o instante dourado de auxiliar. Haja o que houver, distribua confiança e bom ânimo, porque a alegria é talvez a única dádiva que você é capaz de ofertar sem possuir. Evite amargura e desespero, porque todos estamos seguindo ao encontro do júbilo imperecível. Se você não acredita que Deus é plenitude de paz e amor, alegria e luz, pense que a Terra poderá envolver - se nas sombras da noite, mas haverá sempre no Céu a fatalidade do alvorecer.'
    },
    {
        id: 'paiNossoPsicografado',
        titulo: 'Pai Nosso Psicografado',
        texto: 'Pai Nosso que estais nos céus, Na luz dos sóis infinitos, Pai de todos os Mitos Deste mundo de escarcéus. Santificado, Senhor, Seja o teu nome sublime, Que em todo﻿ o Universo exprime Concórdia ternura e amor Venha ao nosso coração O teu reino﻿ de bondade, De paz e de claridade Na estrada da redenção. Cumpra-se o teu mandamento Que não vacila﻿ e nem erra, Nos Céus, como em toda a Terra De luta e de sofrimento Evitamos todo o﻿ mal, Damos o pão no caminho, Feito na luz, no carinho Do pão espiritual. Perdoamos, meu Senhor, Os débitos tenebrosos, De passados escabrosos, De iniqüidade e de dor, Auxiliamos, também, Nos sentimentos cristãos, A amar nossos irmãos… Que vivem longe do bem. Com a proteção de Jesus, Livra a nossa alma do erro, Sobre o mundo de desterro, Distante da vossa luz. Que a nossa ideal﻿ igreja seja o altar da Caridade, Onde, se faça a vontade, Do vosso amor… Assim seja.'
    },
    {
        id: 'relato',
        titulo: 'Relato',
        texto: 'Relato de um espírito que trabalha dentro da falange de Maria Mulambo! Nunca fui Rainha apenas trabalho dentro da falange da primeira Mulambo essa sim foi Rainha mas eu não sou rainha, nunca fui. Eu fui uma lavadeira nas terras de Pernambuco, nunca tive reino, nunca tive súditos, nunca usei coroa, nunca usei roupas belas. Tive uma vida simples, fui uma mulher simples, fui resgatada por um espírito que trabalhava na falange de Maria Mulambo. Quando viva meu erro foi praticar abortos e se envolver com homens casados por interesses, vaidades, luxúria e maldades. Eu engravidava desses homens e abortava quando engravidava por isso fui parar em um "presídio" espíritual fiquei por lá muito tempo, meu desencarne foi durante esses abortos que eu realizava. Perdi as contas de quantos abortos eu realizei, também fazia abortos em mulheres que ganhavam a vida em prostíbulos. Minha penitência foi ficar presa em uma esfera espiritual até entender que eu mesma fui minha maior inimiga, até eu entender que destrui muitas Vidas. Paguei caro pelas minhas más escolhas, paguei um preço alto pela minha frieza e vaidade. Cometi um dos piores e mais grave erro  o aborto. Fiquei presa as teias que eu mesma construí em vida. Fiz muitas pessoas chorarem, porém meu choro durou uma eternidade, até hoje sinto essa dor ao ver alguém abortar. Hoje trabalho dentro da falange de mulambo aconselhando e orientando espíritos que se envolveram com homens casados engravidaram dos mesmo e cometeram abortos. Essa é a minha função, ajudar, orientar, esclarecer, retirar da escuridão e da maldade espíritos que assim como eu não tinham amor próprio e por um amor ilusório e apego destruía vidas. Foi me consedida mais uma chance! Em vida fui trevas quando MULAMBO me resgatou enxerguei a luz! Hoje Sou apenas uma trabalhadora dentro da falange de  Maria Mulambo, sou apenas uma entre as milhares de Marias.',
    },
    {
        id: 'confiaSempre',
        titulo: 'Confie Sempre',
        texto: 'Não percas a tua fé entre as sombras do mundo. Ainda que os teus pés estejam sangrando, segue para a frente, erguendo-a por luz celeste, acima de ti mesmo. Crê e trabalha. Esforça-te no bem e espera com paciência. Tudo passa e tudo se renova na terra, mas o que vem do céu permanecerá. De todos os infelizes os mais desditosos são os que perderam a confiança em Deus e em si mesmo, porque o maior infortúnio é sofrer a privação da fé e prosseguir vivendo. Eleva, pois, o teu olhar e caminha. Luta e serve. Aprende e adianta-te. Brilha a alvorada além da noite. Hoje, é possível que a tempestade te amarfanhe o coração e te atormente o ideal, aguilhoando-te com a aflição ou ameaçando-te com a morte. Não te esqueças, porém, de que amanhã será outro dia.',
    },
    {
        id: 'oracaoNossa',
        titulo: 'Oração Nossa',
        texto: 'Senhor ensina-nos a orar, sem esquecer o trabalho. A dar, sem olhar a quem. A servir, sem perguntar até quando...A sofrer, sem magoar, seja quem for. A progredir, sem perder a simplicidade. A semear o bem, sem pensar nos resultados...A desculpar, sem condições. A marchar para frente, sem contar os obstáculos. A ver sem malícia...A escutar, sem corromper os assuntos. A falar, sem ferir. A compreender o próximo, sem exigir entendimento...A respeitar os semelhantes, sem reclamar consideração. A dar o melhor de nós, além da execução do próprio dever, sem cobrar taxas de reconhecimento...Senhor, fortalece em nós, a paciência para com as dificuldades dos outros, assim como precisamos da paciência dos outros, para com as nossas próprias dificuldades...Ajuda-nos para que a ninguém façamos aquilo que não desejamos para nós...Auxilia-nos, sobretudo, a reconhecer que a nossa felicidade mais alta será, invariavelmente, aquela de cumprir seus desígnios onde e como queiras, hoje, agora e sempre.',
    },
    {
        id: 'aguaPura',
        titulo: 'Agua Pura',
        texto: 'A água pura, a fim de manter-se pura é servida em taça vazia. A treva da meia noite é a ocasião em que o tempo dá sinal de partida para novo alvorecer .Por maior que seja a dificuldade, jamais desanime. O nosso pior momento na vida é sempre o momento de melhorar.',
    },
    {
        id: 'aCaridade',
        titulo: 'A caridade',
        texto: 'A caridade é um exercício espiritual...Quem pratica o bem, coloca em movimento forças da alma. Quando os espíritos nos recomendam, com insistência a prática da caridade, eles estão nos orientando no sentido de nossa própria evolução; não se trata apenas de uma indicação ética, mas de profundo significado filosófico...',
    },
    {
        id: 'aHomossexualidade',
        titulo: 'A homossexualidade',
        texto: 'A homossexualidade, tanto quanto a bissexualidade, como assexualidade, são condições da alma humana. Não devem ser interpretadas como fenômenos espantosos, como fenômenos atacáveis pelo ridículo da humanidade. Tanto quanto acontece com a maioria que desfruta de uma sexualidade dita normal, aqueles que são portadores de sentimentos de homossexualidade ou bissexualidade são dignos do nosso maior respeito.',
    }
]
